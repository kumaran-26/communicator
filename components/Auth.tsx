                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 pr-3 py-3 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all shadow-sm"
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-12 py-3 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all shadow-sm"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
