...
import { Send, Check, CheckCheck, ArrowLeft, MoreVertical, Phone, Video, Users as UsersIcon, Smile } from 'lucide-react';
...
const ChatWindow = ({ 
  ...
  return (
    <div className="flex flex-col h-full bg-[#f0f2f5]">
      ...
      {/* Input */}
      <div className="bg-white px-4 py-3 border-t border-gray-200 shrink-0 relative">
        {/* Emoji Picker Overlay */}
        {showEmojiPicker && (
            <div className="absolute bottom-full left-4 mb-2 z-50 shadow-2xl rounded-2xl border border-gray-200">
        ...
        <form onSubmit={handleSend} className="flex items-center space-x-2">
          <button 
            ...
            className={`p-2 rounded-full transition-colors ${showEmojiPicker ? 'bg-violet-100 text-violet-600' : 'text-gray-400 hover:bg-gray-100 hover:text-gray-600'}`}
          >
            <Smile size={24} />
          </button>
          <input
